...
# Nome file originale: DQrules_2.R
...
if(properties$id_centro == id_aiocc) {
  ...
  for (m in dags) {
    ...
    colnames(check_summary) <- c("Variable", "Is Core","Instrument", "Denominator","% missing", "% missing + unknown")
